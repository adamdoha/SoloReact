      ...
      <Storage.Consumer>
        {(store) => (
          <StFilterMenuCont>
            ...
            <StFilterCont id="mask" onClick={store.changefilterType}>
              <PortraitIcon fontSize="large" />
              <label>Mask</label>
            </StFilterCont>

            <StFilterCont id="pixelate" onClick={store.changefilterType}>
              <GradientIcon fontSize="large" />
              <label>Pixelate</label>
            </StFilterCont>

            <StFilterCont id="noise" onClick={store.changefilterType}>
