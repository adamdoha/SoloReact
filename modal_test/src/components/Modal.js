      ...
      <Storage.Consumer>
        {(store) => (
          <>
            ...
            <Zoom
              in={store.curMode === 'origin' || store.curMode === 'backToMain'}
              timeout={200}
              mountOnEnter
              unmountOnExit
            >
              <StModalCont>
                <StConfirmCont>
                  ...
                  <StBtnCont>
                    <Button id="yes" variant="outlined" onClick={store.confirm}>
                      예
                    </Button>
                    <Button id="no" variant="outlined" onClick={store.confirm}>
                      아니요
                    </Button>
                  </StBtnCont>
                </StConfirmCont>
